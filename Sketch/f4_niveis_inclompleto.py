...
def main():
    ...
    parser.add_argument('-np', '--numered_paint', help="Mode where you must paint according to the numbers", required=False, action='store_true')
