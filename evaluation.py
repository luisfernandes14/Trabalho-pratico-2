...
#Olá professor, como mencionado na aula este ficheiro encontra-se 
        # incompleto e servia de teste para o modo de evaluation (funcionalidade 5) que acabou por não ficar completamente funcional

        #usar o "-np" apenas neste código
        #Obrigado da nossa parte
...
def main():
    ...
    if args['numered_paint'] is True:
        if args['use_mirror_mode']is True: #ambos os argumentos para numbered paint e mirror mode ligados
            ...
            #num_cols=int(input("Qual o numero de colunas desejado"))   We didnt define arbitrary number of cols and rows in this code
            ...
            zone_colors = {                    #In BGR this are the correct colors per region
                                1: (0, 0, 255),  # Blue
                                2: (0, 255, 0),  # Green
                                3: (255, 0, 0)   # Red
                            }
            ...
            tela = np.ones((size[1], size[0], 3), dtype = np.uint8)*255
            #num_cols=input("Qual o numero de colunas desejado")                         
                    ...
                    if (area > 10000): 
                        ...
                        if args["numered_paint"]:
                            if num_sections > 1:
                                ...
                                #Zone detection and getting the correct color for each zone    
                                ...
                                if correct_color:
                                    ...
                                    #get evaluation_results from this, to decide wether the color painted corresponds to the correct color of the zone
                                    if is_correct_color:
    ...
    #From evaluation results get the score of the test in the end   
